      ...
      >
        <Link to="/">
          <img
            src={ingravityLogo}
            alt="contact us"
            className="rounded-full object-cover w-12 h-12 shadow-xl hover:shadow-thOrange   duration-300"
          />
        </Link>
        {isVideoPlaying ? (
          <FaPauseCircle
        ...
        <Link to="/productos">
          <img
            src={rollerLogo}
            alt="contact us"
            className="rounded-full object-cover w-12 h-12 shadow-xl hover:shadow-thBlue  duration-300 "
          />
        </Link>
      </div>
    </div>
